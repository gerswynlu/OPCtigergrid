        ...
        <div>
          <div className="bg-gray-100 p-8 rounded-lg w-full sm:w-[700px] h-auto sm:h-[2200px] flex flex-col items-center justify-center">
            ...
            <div className="flex justify-center mt-5">
              ...
              <Link
                to={nextDisabled ? "#" : "/adminformcheck"}
